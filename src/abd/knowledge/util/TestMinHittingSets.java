...
public class TestMinHittingSets {
    ...
    void run() {
        ...
        try {
            ...
            createConflictSets(conflictSets, seed);        
            
            MinHittingSet hittingSets = new MinHittingSet(false, conflictSets);
            ...
            // After pruning the conflicts sets are pruned by removing the super include set, so a null pointer is here and the program is planted
